...
{
    [Fact]
    public async Task OfficeSchema_ReturnsTheFullThirteenVerbSurface()
    {
    ...
    public async Task OfficeSchema_UnknownVerb_ListsAllVerbsAsCandidates()
    {
        ...
        Assert.Equal(13, error.GetProperty("candidates").GetArrayLength());
    }
