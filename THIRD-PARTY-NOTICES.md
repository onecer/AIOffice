...
AIOffice is 100% self-built: it bundles **no third-party binaries, engines, or
executables**. The only third-party material it depends on are the open-source
NuGet libraries listed below, consumed as ordinary package references.
...
Each package retains its own copyright. Full license texts are available at
the linked repositories and on [nuget.org](https://www.nuget.org).
