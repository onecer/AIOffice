...
- **1253 个测试**横跨 7 个项目（Core 124 · Word 385 · Excel 299 · Pptx 327 · MCP 63 · Preview 24 · Render 31），每次提交全绿。
...
- **M7（种子）** —— pptx/xlsx 公式（幻灯片与单元格内的 OMML）· 插件机制（外部格式 handler）· 现代 xlsx 批注打磨 · 动画预设++（完整强调/退出全集、效果链、motion path）· OLE 对象 · 无障碍 / alt-text 审计。
