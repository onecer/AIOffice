...
- **724 个测试**横跨 7 个项目（Core 112 · Word 186 · Pptx 159 · Excel 168 · MCP 44 · Preview 24 · Render 31），每次提交全绿。
...
- **M4（种子）** —— 嵌入式图表工作簿（PowerPoint 内可编辑数据）· 动画 · 尾注 · docx 多节（插入分节符）· 大工作簿写入流式 · 跨 run find/replace · 数据验证 · 连接线与组合。
