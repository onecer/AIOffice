...
- **1053 个测试**横跨 7 个项目（Core 112 · Word 300 · Excel 260 · Pptx 264 · MCP 62 · Preview 24 · Render 31），每次提交全绿。
...
- **M6（种子）** —— 大工作簿就地写入流式 · 插件机制（外部格式 handler）· 公式（OMML）· RTL 深化 · 现代 pptx 线程批注 part · 动画时间轴编辑（效果链、motion path）· 连接线与组合。
