...
| 格式 | M0（v0.1.0） | + M1（v0.2.0） | + M2（v0.3.0） | + M3（v0.4.0） | + M4（v0.5.0） | + M5（v0.6.0） | + M6（v0.7.0） | + M7（v0.8.0） | + M8（v0.9.0） | + M9（v0.10.0） | + M10（v0.11.0） |
|---|---|---|---|---|---|---|---|---|---|---|---|
...
- **1590 个测试**横跨 7 个项目（Core 124 · Word 481 · Excel 400 · Pptx 443 · MCP 87 · Preview 24 · Render 31），每次提交全绿。
