...
| 🗺 M9 | 深水区余项：pptx/xlsx 公式（复用 `AIOffice.Word.Equations` 转换器）、跨格式转换 docx↔pptx、OLE 对象、插件机制、1.0 加固、现代 xlsx 批注打磨、动画预设++、多效果动画链/motion path、dump 回放 |
...
| 范围 | ✅ 已实现（M0–M8） | 🔜 M1 余项 | 📋 M2 余项 | 🗺 深水区（M9） | ❌ 不计划 | 合计 |
|---|---|---|---|---|---|---|
| 跨格式通用 | 28 | 3 | 5 | 4 | 3 | 43 |
| docx | 24 | 1 | 6 | 5 | 0 | 36 |
| xlsx | 26 | 4 | 6 | 5 | 0 | 41 |
| pptx | 21 | 3 | 5 | 10 | 0 | 39 |
| **合计** | **99** | **11** | **22** | **24** | **3** | **159** |
