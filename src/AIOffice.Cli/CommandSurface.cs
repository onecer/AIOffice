    ...
    [
        ...
        new("edit",
            ...
            [
                ...
                new("type", "<element>", "Element type for --add, e.g. p, table, slide, shape, image, comment, style, pivot, conditionalFormat, toc, watermark, endnote, sectionBreak, animation, note, row, col."),
