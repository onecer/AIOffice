...
internal static class PptxEditor
{
    ...
    private static readonly IReadOnlyList<string> ShapePropKeys =
        ["text", "x", "y", "w", "h", "fill", "gradient", "image", "fontSize", "bold", "color", "align", "name", "title", "altText", "altTitle",
         "shadow", "glow", "reflection", "outline", "softEdge", "innerShadow", "bevel", "scene3d", "autofit",
        ...
        foreach (var (key, value) in props)
        {
            switch (RequireKnownPropKey(key, ShapePropKeys))
            {
                ...
                case "softEdge":
                    ...
                    break;
                case "innerShadow":
                    PptxEffects.SetInnerShadow(view, value);
                    break;
                case "bevel":
                    PptxEffects.SetBevel(view, value);
                    break;
                case "scene3d":
                    PptxEffects.SetScene3D(view, value);
                    break;
                ...
                default:
                    throw new AiofficeException(
                        ...
                        "reflection, outline, softEdge, inner shadow, bevel and scene3d (lines also fill for the stroke color); text and styling props " +
